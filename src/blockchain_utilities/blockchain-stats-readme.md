...
See also the utility's help option. `xcash-blockchain-stats --help`

From the command line run:

`$ xcash-blockchain-stats`
...
- `xcash-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `xcash-blockchain-stats | save-to-database.sh`
